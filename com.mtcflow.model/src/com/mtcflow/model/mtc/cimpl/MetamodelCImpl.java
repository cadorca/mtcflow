...
public class MetamodelCImpl  extends com.mtcflow.model.mtc.impl.MetamodelImpl {
	...
	public String getAlias() {
		...
		if(mtc!=null && mtc.getExecutionInformation() !=null && mtc.getExecutionInformation().get("variables")!=null ){
			Map variables = (Map) mtc.getExecutionInformation().get("variables");
			return strSubstitutor.replace(super.getAlias(), variables);
		}
		else
	...
	public String getMetamodelURI() {
		...
		if(mtc!=null && mtc.getExecutionInformation() !=null && mtc.getExecutionInformation().get("variables")!=null ){
			Map variables = (Map) mtc.getExecutionInformation().get("variables");
			return strSubstitutor.replace(super.getMetamodelURI(), variables);
		}
		else
		return super.getMetamodelURI();
	}
