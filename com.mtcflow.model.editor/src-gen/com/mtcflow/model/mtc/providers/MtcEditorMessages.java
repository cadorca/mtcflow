 ...
 * 
 */
public class MtcEditorMessages extends NLS {
	
	private static final String BUNDLE_NAME = "com.mtcflow.model.mtc.providers.mtcEditorMessages"; //$NON-NLS-1$


	
	public static String Main_ReadOnly;

	
	public static String Main_Part_Title;
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, MtcEditorMessages.class);
	}

	
	private MtcEditorMessages() {
