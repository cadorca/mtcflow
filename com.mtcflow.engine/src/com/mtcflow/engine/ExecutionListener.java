...
public class ExecutionListener implements IExecutionListener {
	...
	@Override
	public void modelReady(Model model, Transformation transformation, IExecutionEnvironment executionEnvironment) {

	}

	@Override
	public void fileReady(File model, Transformation transformation, IExecutionEnvironment executionEnvironment) {
