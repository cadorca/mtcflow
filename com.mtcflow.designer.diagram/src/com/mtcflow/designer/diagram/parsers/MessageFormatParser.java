 ...
 * 
 */
package com.mtcflow.designer.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(MtcDiagramEditorPlugin.ID, IParserEditStatus.UNEDITABLE, NLS.bind(Messages.MessageFormatParser_InvalidInputError, new Integer(pos.getErrorIndex())));
		}
