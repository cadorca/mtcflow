 ...
 * @generated
 */
public class ScriptCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		Script newElement = MtcFactory.eINSTANCE.createScript();

		Configuration owner = (Configuration) getElementToEdit();
		owner.getScripts().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(Script newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
