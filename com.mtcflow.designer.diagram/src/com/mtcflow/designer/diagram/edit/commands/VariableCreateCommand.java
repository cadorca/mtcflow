...
public class VariableCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		Variable newElement = MtcFactory.eINSTANCE.createVariable();
	 ...
	 * @generated
	 */
	protected void doConfigure(Variable newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
