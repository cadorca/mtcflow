 ...
 * @generated
 */
public class MTCResourceReferencedResourcesExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(MtcVisualIDRegistry.getType(com.mtcflow.designer.diagram.edit.parts.MTCResourceReferencedResourcesExternalLabelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public MTCResourceReferencedResourcesExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MtcParserProvider.getParser(MtcElementTypes.MTCResourceReferencedResources_4033, getParserElement(), CommonParserHint.DESCRIPTION);
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new MTCResourceReferencedResourcesExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class MTCResourceReferencedResourcesExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public MTCResourceReferencedResourcesExternalLabelFigure() {
			this.setText("ref");
