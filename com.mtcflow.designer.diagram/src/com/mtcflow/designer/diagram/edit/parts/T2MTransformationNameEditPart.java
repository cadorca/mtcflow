 ...
 * @generated
 */
public class T2MTransformationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public T2MTransformationNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MtcParserProvider.getParser(MtcElementTypes.T2MTransformation_2028, getParserElement(), MtcVisualIDRegistry.getType(com.mtcflow.designer.diagram.edit.parts.T2MTransformationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
