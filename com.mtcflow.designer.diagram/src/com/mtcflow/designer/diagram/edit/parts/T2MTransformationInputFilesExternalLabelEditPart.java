 ...
 * @generated
 */
public class T2MTransformationInputFilesExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(MtcVisualIDRegistry.getType(com.mtcflow.designer.diagram.edit.parts.T2MTransformationInputFilesExternalLabelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public T2MTransformationInputFilesExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MtcParserProvider.getParser(MtcElementTypes.T2MTransformationInputFiles_4035, getParserElement(), CommonParserHint.DESCRIPTION);
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new T2MTransformationInputFilesExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class T2MTransformationInputFilesExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public T2MTransformationInputFilesExternalLabelFigure() {
			this.setText("");
