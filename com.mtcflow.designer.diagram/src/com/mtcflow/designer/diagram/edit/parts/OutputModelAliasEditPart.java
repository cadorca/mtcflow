 ...
 * @generated
 */
public class OutputModelAliasEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(MtcVisualIDRegistry.getType(com.mtcflow.designer.diagram.edit.parts.OutputModelAliasEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public OutputModelAliasEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MtcParserProvider.getParser(MtcElementTypes.OutputModel_4028, getParserElement(), MtcVisualIDRegistry.getType(com.mtcflow.designer.diagram.edit.parts.OutputModelAliasEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new OutputModelLabelFigure();
	}

	/**
	 * @generated
	 */
	public class OutputModelLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public OutputModelLabelFigure() {
			this.setText("OutputModel");
