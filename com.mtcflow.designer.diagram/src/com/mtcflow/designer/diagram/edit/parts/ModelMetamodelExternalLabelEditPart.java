 ...
 * @generated
 */
public class ModelMetamodelExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(MtcVisualIDRegistry.getType(com.mtcflow.designer.diagram.edit.parts.ModelMetamodelExternalLabelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public ModelMetamodelExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MtcParserProvider.getParser(MtcElementTypes.ModelMetamodel_4043, getParserElement(), CommonParserHint.DESCRIPTION);
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new ModelMetamodelExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ModelMetamodelExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ModelMetamodelExternalLabelFigure() {
			this.setText("conforms to");
