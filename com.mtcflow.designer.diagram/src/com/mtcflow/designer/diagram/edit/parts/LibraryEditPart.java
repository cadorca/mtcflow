...
import com.mtcflow.designer.diagram.edit.policies.LibraryGraphicalNodeEditPolicy;
import com.mtcflow.designer.diagram.edit.policies.LibraryItemSemanticEditPolicy;
...
public class LibraryEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new LibraryItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE, new LibraryGraphicalNodeEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LibraryNameEditPart) {
			((LibraryNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureLibraryLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MtcVisualIDRegistry.getType(LibraryNameEditPart.VISUAL_ID));
	}
	...
	public class LibraryFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureLibraryLabelFigure.setFont(FFIGURELIBRARYLABELFIGURE_FONT);

			fFigureLibraryLabelFigure.setBorder(new MarginBorder(getMapMode().DPtoLP(0), getMapMode().DPtoLP(1), getMapMode().DPtoLP(0), getMapMode().DPtoLP(5)));
	 ...
	 * @generated
	 */
	static final Font FFIGURELIBRARYLABELFIGURE_FONT = new Font(Display.getCurrent(), "Arial", 12, SWT.NORMAL);
