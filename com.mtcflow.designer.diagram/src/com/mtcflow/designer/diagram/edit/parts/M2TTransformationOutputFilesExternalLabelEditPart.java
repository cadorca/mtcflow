 ...
 * @generated
 */
public class M2TTransformationOutputFilesExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(MtcVisualIDRegistry.getType(com.mtcflow.designer.diagram.edit.parts.M2TTransformationOutputFilesExternalLabelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public M2TTransformationOutputFilesExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MtcParserProvider.getParser(MtcElementTypes.M2TTransformationOutputFiles_4034, getParserElement(), CommonParserHint.DESCRIPTION);
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new M2TTransformationOutputFilesExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class M2TTransformationOutputFilesExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public M2TTransformationOutputFilesExternalLabelFigure() {
			this.setText("generates");
