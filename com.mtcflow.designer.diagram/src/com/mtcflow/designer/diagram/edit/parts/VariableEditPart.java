...
import com.mtcflow.designer.diagram.edit.policies.VariableItemSemanticEditPolicy;
...
public class VariableEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof VariableNameEditPart) {
			((VariableNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureVariableLabelFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MtcVisualIDRegistry.getType(VariableNameEditPart.VISUAL_ID));
	}
	...
	public class VariableFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureVariableLabelFigure.setFont(FFIGUREVARIABLELABELFIGURE_FONT);

			fFigureVariableLabelFigure.setBorder(new MarginBorder(getMapMode().DPtoLP(0), getMapMode().DPtoLP(1), getMapMode().DPtoLP(0), getMapMode().DPtoLP(5)));
	 ...
	 * @generated
	 */
	static final Font FFIGUREVARIABLELABELFIGURE_FONT = new Font(Display.getCurrent(), "Arial", 12, SWT.NORMAL);
