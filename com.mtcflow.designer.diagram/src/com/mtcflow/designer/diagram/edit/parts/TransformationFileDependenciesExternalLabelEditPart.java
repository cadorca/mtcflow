 ...
 * @generated
 */
public class TransformationFileDependenciesExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(MtcVisualIDRegistry.getType(com.mtcflow.designer.diagram.edit.parts.TransformationFileDependenciesExternalLabelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public TransformationFileDependenciesExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MtcParserProvider.getParser(MtcElementTypes.TransformationFileDependencies_4041, getParserElement(), CommonParserHint.DESCRIPTION);
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new TransformationFileDependenciesExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TransformationFileDependenciesExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TransformationFileDependenciesExternalLabelFigure() {
