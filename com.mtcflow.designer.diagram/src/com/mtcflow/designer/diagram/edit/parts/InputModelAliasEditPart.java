 ...
 * @generated
 */
public class InputModelAliasEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(MtcVisualIDRegistry.getType(com.mtcflow.designer.diagram.edit.parts.InputModelAliasEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public InputModelAliasEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MtcParserProvider.getParser(MtcElementTypes.InputModel_4027, getParserElement(), MtcVisualIDRegistry.getType(com.mtcflow.designer.diagram.edit.parts.InputModelAliasEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new InputModelLabelFigure();
	}

	/**
	 * @generated
	 */
	public class InputModelLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public InputModelLabelFigure() {
			this.setText("InputModel");
