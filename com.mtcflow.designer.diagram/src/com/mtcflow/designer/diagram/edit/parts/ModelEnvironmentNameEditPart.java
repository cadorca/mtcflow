 ...
 * @generated
 */
public class ModelEnvironmentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ModelEnvironmentNameEditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		...
		return MtcElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MtcParserProvider.getParser(MtcElementTypes.ModelEnvironment_3013, getParserElement(), MtcVisualIDRegistry.getType(com.mtcflow.designer.diagram.edit.parts.ModelEnvironmentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
