...
import com.mtcflow.designer.diagram.edit.policies.MtcTextSelectionEditPolicy;
 ...
 * @generated
 */
public class HOTransformationOutputTransformationsExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(MtcVisualIDRegistry.getType(com.mtcflow.designer.diagram.edit.parts.HOTransformationOutputTransformationsExternalLabelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public HOTransformationOutputTransformationsExternalLabelEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new MtcTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MtcParserProvider.getParser(MtcElementTypes.HOTransformationOutputTransformations_4039, getParserElement(), CommonParserHint.DESCRIPTION);
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null, MtcEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	protected IFigure createFigurePrim() {
		return new HOTransformationOutputTransformationsExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class HOTransformationOutputTransformationsExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public HOTransformationOutputTransformationsExternalLabelFigure() {
			this.setText("GEN");

			this.setFont(THIS_FONT);

			this.setBorder(new MarginBorder(getMapMode().DPtoLP(0), getMapMode().DPtoLP(1), getMapMode().DPtoLP(0), getMapMode().DPtoLP(5)));
		}
