 ...
 * @generated
 */
public class TransformationModelDependenciesExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(MtcVisualIDRegistry.getType(com.mtcflow.designer.diagram.edit.parts.TransformationModelDependenciesExternalLabelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public TransformationModelDependenciesExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MtcParserProvider.getParser(MtcElementTypes.TransformationModelDependencies_4040, getParserElement(), CommonParserHint.DESCRIPTION);
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new TransformationModelDependenciesExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TransformationModelDependenciesExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TransformationModelDependenciesExternalLabelFigure() {
			this.setText("depends on");
