 ...
 * @generated
 */
public class ModelValidationsExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(MtcVisualIDRegistry.getType(com.mtcflow.designer.diagram.edit.parts.ModelValidationsExternalLabelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public ModelValidationsExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MtcParserProvider.getParser(MtcElementTypes.ModelValidations_4031, getParserElement(), CommonParserHint.DESCRIPTION);
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new ModelValidationsExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ModelValidationsExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ModelValidationsExternalLabelFigure() {
			this.setText("");
