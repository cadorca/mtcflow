...
public class VariableNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = MtcParserProvider.getParser(MtcElementTypes.Variable_3010, getParserElement(), MtcVisualIDRegistry.getType(com.mtcflow.designer.diagram.edit.parts.VariableNameEditPart.VISUAL_ID));
		}
		return parser;
	}
