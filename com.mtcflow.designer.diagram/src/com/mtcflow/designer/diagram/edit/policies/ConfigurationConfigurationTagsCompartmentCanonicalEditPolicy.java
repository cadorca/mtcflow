 ...
 * @generated
 */
public class ConfigurationConfigurationTagsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<MtcNodeDescriptor> childDescriptors = MtcDiagramUpdater.getConfigurationConfigurationTagsCompartment_7009SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return TagEditPart.VISUAL_ID == MtcVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<MtcNodeDescriptor> childDescriptors = MtcDiagramUpdater.getConfigurationConfigurationTagsCompartment_7009SemanticChildren((View) getHost().getModel());
