 ...
 * @generated
 */
public class ConfigurationItemSemanticEditPolicy extends MtcBaseItemSemanticEditPolicy {
	...
	private void addDestroyChildNodesCommand(ICompositeCommand cmd) {
		...
		for (Iterator<?> nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			switch (MtcVisualIDRegistry.getVisualID(node)) {
			case ConfigurationConfigurationVariablesCompartmentEditPart.VISUAL_ID:
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					Node cnode = (Node) cit.next();
					switch (MtcVisualIDRegistry.getVisualID(cnode)) {
