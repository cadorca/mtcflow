 ...
 * @generated
 */
public class MTCTransformationItemSemanticEditPolicy extends MtcBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public MTCTransformationItemSemanticEditPolicy() {
		super(MtcElementTypes.MTCTransformation_2029);
	}
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (MtcElementTypes.HOTransformationOutputTransformations_4039 == req.getElementType()) {
			return getGEFWrapper(new HOTransformationOutputTransformationsCreateCommand(req, req.getTarget(), req.getSource()));
		}
