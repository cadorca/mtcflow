 ...
 * @generated
 */
public class ConfigurationConfigurationEnvironmentsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<MtcNodeDescriptor> childDescriptors = MtcDiagramUpdater.getConfigurationConfigurationEnvironmentsCompartment_7012SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ModelEnvironmentEditPart.VISUAL_ID == MtcVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<MtcNodeDescriptor> childDescriptors = MtcDiagramUpdater.getConfigurationConfigurationEnvironmentsCompartment_7012SemanticChildren((View) getHost().getModel());
