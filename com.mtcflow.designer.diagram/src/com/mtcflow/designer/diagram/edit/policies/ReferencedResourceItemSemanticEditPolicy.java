 ...
 * @generated
 */
public class ReferencedResourceItemSemanticEditPolicy extends MtcBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ReferencedResourceItemSemanticEditPolicy() {
		super(MtcElementTypes.ReferencedResource_2035);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (MtcVisualIDRegistry.getVisualID(incomingLink) == MTCResourceReferencedResourcesEditPart.VISUAL_ID) {
