 ...
 * @generated
 */
public class ConfigurationConfigurationLibrariesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<MtcNodeDescriptor> childDescriptors = MtcDiagramUpdater.getConfigurationConfigurationLibrariesCompartment_7010SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return LibraryEditPart.VISUAL_ID == MtcVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<MtcNodeDescriptor> childDescriptors = MtcDiagramUpdater.getConfigurationConfigurationLibrariesCompartment_7010SemanticChildren((View) getHost().getModel());
