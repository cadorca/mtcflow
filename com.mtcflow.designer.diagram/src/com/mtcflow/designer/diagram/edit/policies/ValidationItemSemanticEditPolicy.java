 ...
 * @generated
 */
public class ValidationItemSemanticEditPolicy extends MtcBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ValidationItemSemanticEditPolicy() {
		super(MtcElementTypes.Validation_2034);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (MtcVisualIDRegistry.getVisualID(incomingLink) == ModelValidationsEditPart.VISUAL_ID) {
