 ...
 * @generated
 */
public class ConfigurationConfigurationVariablesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<MtcNodeDescriptor> childDescriptors = MtcDiagramUpdater.getConfigurationConfigurationVariablesCompartment_7008SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return VariableEditPart.VISUAL_ID == MtcVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<MtcNodeDescriptor> childDescriptors = MtcDiagramUpdater.getConfigurationConfigurationVariablesCompartment_7008SemanticChildren((View) getHost().getModel());
