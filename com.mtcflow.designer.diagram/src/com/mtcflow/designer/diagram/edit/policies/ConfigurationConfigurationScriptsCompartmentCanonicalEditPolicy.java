 ...
 * @generated
 */
public class ConfigurationConfigurationScriptsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<MtcNodeDescriptor> childDescriptors = MtcDiagramUpdater.getConfigurationConfigurationScriptsCompartment_7011SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ScriptEditPart.VISUAL_ID == MtcVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<MtcNodeDescriptor> childDescriptors = MtcDiagramUpdater.getConfigurationConfigurationScriptsCompartment_7011SemanticChildren((View) getHost().getModel());
