 ...
 * @generated
 */
public class MtcElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public MtcElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(Messages.MtcElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "mtc".equals(fileExtension); //$NON-NLS-1$
	}
	...
	private class ModelElementsTreeContentProvider implements ITreeContentProvider {
		 ...
		 * @generated
		 */
		private AdapterFactoryContentProvider myAdapterFctoryContentProvier = new AdapterFactoryContentProvider(MtcDiagramEditorPlugin.getInstance().getItemProvidersAdapterFactory());
		...
		public Object[] getChildren(Object parentElement) {
			...
			if (parentElement instanceof IFile) {
				...
				try {
					...
					MtcDiagramEditorPlugin.getInstance().logError("Unable to load resource: " + resourcePath.toString(), e); //$NON-NLS-1$
				}
	...
	private class ModelElementsTreeLabelProvider implements ILabelProvider {
		 ...
		 * @generated
		 */
		private AdapterFactoryLabelProvider myAdapterFactoryLabelProvider = new AdapterFactoryLabelProvider(MtcDiagramEditorPlugin.getInstance().getItemProvidersAdapterFactory());
			...
			if (event.getSelection() instanceof IStructuredSelection) {
				...
				if (selection.size() == 1) {
					...
					if (selectedElement instanceof EObject) {
						...
						setOkButtonEnabled(ViewService.getInstance().provides(Node.class, new EObjectAdapter(selectedModelElement), myView, null, ViewUtil.APPEND, true, MtcDiagramEditorPlugin.DIAGRAM_PREFERENCES_HINT));
