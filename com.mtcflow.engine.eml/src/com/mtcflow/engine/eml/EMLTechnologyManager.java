...
public class EMLTechnologyManager implements ITechnologyManager {
	...
	private final static String EOL_SOURCE_EXTENSION = "eml";
	private final static String EOL_COMPILED_EXTENSION = "eml";
	...
	public ITransformationExecutor createTransformationExecutor(Transformation transformation) {
		return new EMLTransformationExecutor();
	}
