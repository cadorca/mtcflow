 ...
 * 
 */
public class M2MTransformationPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public M2MTransformationPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject m2MTransformation, String editing_mode) {
		super(editingContext, m2MTransformation, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = MtcViewsRepository.class;
		partKey = MtcViewsRepository.M2MTransformation.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final M2MTransformation m2MTransformation = (M2MTransformation)elt;
			final M2MTransformationPropertiesEditionPart basePart = (M2MTransformationPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(MtcViewsRepository.M2MTransformation.Advanced.properties)) {
				propertiesSettings = new ReferencesTableSettings(m2MTransformation, MtcPackage.eINSTANCE.getConfigurable_Properties());
				basePart.initProperties(propertiesSettings);
			}
			if (isAccessible(MtcViewsRepository.M2MTransformation.Basic.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, m2MTransformation.getName()));
			
				if (isAccessible(MtcViewsRepository.M2MTransformation.Basic.uRI)) {
					basePart.setURI(EEFConverterUtil.convertToString(MtcPackage.eINSTANCE.getMTCResource_URI().getEAttributeType(), m2MTransformation.getURI()));
				}
			
			if (isAccessible(MtcViewsRepository.M2MTransformation.Advanced.tags)) {
				tagsSettings = new ReferencesTableSettings(m2MTransformation, MtcPackage.eINSTANCE.getMTCResource_Tags());
				basePart.initTags(tagsSettings);
			}
			if (isAccessible(MtcViewsRepository.M2MTransformation.Basic.description))
				basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, m2MTransformation.getDescription()));
			
			if (isAccessible(MtcViewsRepository.M2MTransformation.Advanced.referencedResources)) {
				referencedResourcesSettings = new ReferencesTableSettings(m2MTransformation, MtcPackage.eINSTANCE.getMTCResource_ReferencedResources());
				basePart.initReferencedResources(referencedResourcesSettings);
			}
				if (isAccessible(MtcViewsRepository.M2MTransformation.Basic.technology)) {
					basePart.setTechnology(EEFConverterUtil.convertToString(MtcPackage.eINSTANCE.getMTCResource_Technology().getEAttributeType(), m2MTransformation.getTechnology()));
				}
			
				if (isAccessible(MtcViewsRepository.M2MTransformation.Basic.implementationClass)) {
					basePart.setImplementationClass(EEFConverterUtil.convertToString(MtcPackage.eINSTANCE.getTransformation_ImplementationClass().getEAttributeType(), m2MTransformation.getImplementationClass()));
				}
			
			if (isAccessible(MtcViewsRepository.M2MTransformation.Libraries.libraries_)) {
				librariesSettings = new ReferencesTableSettings(m2MTransformation, MtcPackage.eINSTANCE.getTransformation_Libraries());
				basePart.initLibraries(librariesSettings);
			}
			if (isAccessible(MtcViewsRepository.M2MTransformation.Basic.preExecutionScript)) {
				// init part
				preExecutionScriptSettings = new EObjectFlatComboSettings(m2MTransformation, MtcPackage.eINSTANCE.getTransformation_PreExecutionScript());
			...
			if (isAccessible(MtcViewsRepository.M2MTransformation.Basic.postExecutionScript)) {
				// init part
				postExecutionScriptSettings = new EObjectFlatComboSettings(m2MTransformation, MtcPackage.eINSTANCE.getTransformation_PostExecutionScript());
			...
			if (isAccessible(MtcViewsRepository.M2MTransformation.Dependencies.modelDependencies)) {
				modelDependenciesSettings = new ReferencesTableSettings(m2MTransformation, MtcPackage.eINSTANCE.getTransformation_ModelDependencies());
				basePart.initModelDependencies(modelDependenciesSettings);
			}
			if (isAccessible(MtcViewsRepository.M2MTransformation.Dependencies.fileDependencies)) {
				fileDependenciesSettings = new ReferencesTableSettings(m2MTransformation, MtcPackage.eINSTANCE.getTransformation_FileDependencies());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == MtcViewsRepository.M2MTransformation.Advanced.properties) {
			return MtcPackage.eINSTANCE.getConfigurable_Properties();
		}
		if (editorKey == MtcViewsRepository.M2MTransformation.Basic.name) {
			return MtcPackage.eINSTANCE.getMTCResource_Name();
		}
		if (editorKey == MtcViewsRepository.M2MTransformation.Basic.uRI) {
			return MtcPackage.eINSTANCE.getMTCResource_URI();
		}
		if (editorKey == MtcViewsRepository.M2MTransformation.Advanced.tags) {
			return MtcPackage.eINSTANCE.getMTCResource_Tags();
		}
		if (editorKey == MtcViewsRepository.M2MTransformation.Basic.description) {
			return MtcPackage.eINSTANCE.getMTCResource_Description();
		}
		if (editorKey == MtcViewsRepository.M2MTransformation.Advanced.referencedResources) {
			return MtcPackage.eINSTANCE.getMTCResource_ReferencedResources();
		}
		if (editorKey == MtcViewsRepository.M2MTransformation.Basic.technology) {
			return MtcPackage.eINSTANCE.getMTCResource_Technology();
		}
		if (editorKey == MtcViewsRepository.M2MTransformation.Basic.implementationClass) {
			return MtcPackage.eINSTANCE.getTransformation_ImplementationClass();
		}
		if (editorKey == MtcViewsRepository.M2MTransformation.Libraries.libraries_) {
			return MtcPackage.eINSTANCE.getTransformation_Libraries();
		}
		if (editorKey == MtcViewsRepository.M2MTransformation.Basic.preExecutionScript) {
			return MtcPackage.eINSTANCE.getTransformation_PreExecutionScript();
		}
		if (editorKey == MtcViewsRepository.M2MTransformation.Basic.postExecutionScript) {
			return MtcPackage.eINSTANCE.getTransformation_PostExecutionScript();
		}
		if (editorKey == MtcViewsRepository.M2MTransformation.Dependencies.modelDependencies) {
			return MtcPackage.eINSTANCE.getTransformation_ModelDependencies();
		}
		if (editorKey == MtcViewsRepository.M2MTransformation.Dependencies.fileDependencies) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		M2MTransformation m2MTransformation = (M2MTransformation)semanticObject;
		if (MtcViewsRepository.M2MTransformation.Advanced.properties == event.getAffectedEditor()) {
		...
		if (MtcViewsRepository.M2MTransformation.Basic.name == event.getAffectedEditor()) {
			m2MTransformation.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (MtcViewsRepository.M2MTransformation.Basic.uRI == event.getAffectedEditor()) {
			m2MTransformation.setURI((String)event.getNewValue());
		}
		if (MtcViewsRepository.M2MTransformation.Advanced.tags == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (MtcViewsRepository.M2MTransformation.Basic.description == event.getAffectedEditor()) {
			m2MTransformation.setDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (MtcViewsRepository.M2MTransformation.Advanced.referencedResources == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (MtcViewsRepository.M2MTransformation.Basic.technology == event.getAffectedEditor()) {
			m2MTransformation.setTechnology((String)event.getNewValue());
		}
		if (MtcViewsRepository.M2MTransformation.Basic.implementationClass == event.getAffectedEditor()) {
			m2MTransformation.setImplementationClass((String)event.getNewValue());
		}
		if (MtcViewsRepository.M2MTransformation.Libraries.libraries_ == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (MtcViewsRepository.M2MTransformation.Basic.preExecutionScript == event.getAffectedEditor()) {
		...
		if (MtcViewsRepository.M2MTransformation.Basic.postExecutionScript == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
		...
		if (MtcViewsRepository.M2MTransformation.Dependencies.modelDependencies == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (MtcViewsRepository.M2MTransformation.Dependencies.fileDependencies == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			M2MTransformationPropertiesEditionPart basePart = (M2MTransformationPropertiesEditionPart)editingPart;
			if (MtcPackage.eINSTANCE.getConfigurable_Properties().equals(msg.getFeature()) && isAccessible(MtcViewsRepository.M2MTransformation.Advanced.properties))
				basePart.updateProperties();
			if (MtcPackage.eINSTANCE.getMTCResource_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(MtcViewsRepository.M2MTransformation.Basic.name)) {
			...
			if (MtcPackage.eINSTANCE.getMTCResource_URI().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(MtcViewsRepository.M2MTransformation.Basic.uRI)) {
				if (msg.getNewValue() != null) {
			...
			if (MtcPackage.eINSTANCE.getMTCResource_Tags().equals(msg.getFeature())  && isAccessible(MtcViewsRepository.M2MTransformation.Advanced.tags))
				basePart.updateTags();
			if (MtcPackage.eINSTANCE.getMTCResource_Description().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(MtcViewsRepository.M2MTransformation.Basic.description)) {
				if (msg.getNewValue() != null) {
			...
			if (MtcPackage.eINSTANCE.getMTCResource_ReferencedResources().equals(msg.getFeature())  && isAccessible(MtcViewsRepository.M2MTransformation.Advanced.referencedResources))
				basePart.updateReferencedResources();
			if (MtcPackage.eINSTANCE.getMTCResource_Technology().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(MtcViewsRepository.M2MTransformation.Basic.technology)) {
				if (msg.getNewValue() != null) {
			...
			if (MtcPackage.eINSTANCE.getTransformation_ImplementationClass().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(MtcViewsRepository.M2MTransformation.Basic.implementationClass)) {
				if (msg.getNewValue() != null) {
			...
			if (MtcPackage.eINSTANCE.getTransformation_Libraries().equals(msg.getFeature())  && isAccessible(MtcViewsRepository.M2MTransformation.Libraries.libraries_))
				basePart.updateLibraries();
			if (MtcPackage.eINSTANCE.getTransformation_PreExecutionScript().equals(msg.getFeature()) && basePart != null && isAccessible(MtcViewsRepository.M2MTransformation.Basic.preExecutionScript))
				basePart.setPreExecutionScript((EObject)msg.getNewValue());
			if (MtcPackage.eINSTANCE.getTransformation_PostExecutionScript().equals(msg.getFeature()) && basePart != null && isAccessible(MtcViewsRepository.M2MTransformation.Basic.postExecutionScript))
				basePart.setPostExecutionScript((EObject)msg.getNewValue());
			if (MtcPackage.eINSTANCE.getTransformation_ModelDependencies().equals(msg.getFeature())  && isAccessible(MtcViewsRepository.M2MTransformation.Dependencies.modelDependencies))
				basePart.updateModelDependencies();
			if (MtcPackage.eINSTANCE.getTransformation_FileDependencies().equals(msg.getFeature())  && isAccessible(MtcViewsRepository.M2MTransformation.Dependencies.fileDependencies))
	...
	public boolean isRequired(Object key, int kind) {
		return key == MtcViewsRepository.M2MTransformation.Basic.name;
	}
