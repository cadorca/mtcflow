...
public class FilePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public FilePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject file, String editing_mode) {
		...
		partKey = MtcViewsRepository.File.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(MtcViewsRepository.File.Advanced.properties)) {
				propertiesSettings = new ReferencesTableSettings(file, MtcPackage.eINSTANCE.getConfigurable_Properties());
				basePart.initProperties(propertiesSettings);
			}
			if (isAccessible(MtcViewsRepository.File.Basic.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, file.getName()));
			
				if (isAccessible(MtcViewsRepository.File.Basic.uRI)) {
					basePart.setURI(EEFConverterUtil.convertToString(MtcPackage.eINSTANCE.getMTCResource_URI().getEAttributeType(), file.getURI()));
				}
			
			if (isAccessible(MtcViewsRepository.File.Advanced.tags)) {
				tagsSettings = new ReferencesTableSettings(file, MtcPackage.eINSTANCE.getMTCResource_Tags());
				basePart.initTags(tagsSettings);
			}
			if (isAccessible(MtcViewsRepository.File.Basic.description))
				basePart.setDescription(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, file.getDescription()));
			
			if (isAccessible(MtcViewsRepository.File.Advanced.referencedResources)) {
				referencedResourcesSettings = new ReferencesTableSettings(file, MtcPackage.eINSTANCE.getMTCResource_ReferencedResources());
				basePart.initReferencedResources(referencedResourcesSettings);
			}
				if (isAccessible(MtcViewsRepository.File.Basic.technology)) {
					basePart.setTechnology(EEFConverterUtil.convertToString(MtcPackage.eINSTANCE.getMTCResource_Technology().getEAttributeType(), file.getTechnology()));
				}
			
			if (isAccessible(MtcViewsRepository.File.Basic.type))
				basePart.setType(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, file.getType()));
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == MtcViewsRepository.File.Advanced.properties) {
			return MtcPackage.eINSTANCE.getConfigurable_Properties();
		}
		if (editorKey == MtcViewsRepository.File.Basic.name) {
			return MtcPackage.eINSTANCE.getMTCResource_Name();
		}
		if (editorKey == MtcViewsRepository.File.Basic.uRI) {
			return MtcPackage.eINSTANCE.getMTCResource_URI();
		}
		if (editorKey == MtcViewsRepository.File.Advanced.tags) {
			return MtcPackage.eINSTANCE.getMTCResource_Tags();
		}
		if (editorKey == MtcViewsRepository.File.Basic.description) {
			return MtcPackage.eINSTANCE.getMTCResource_Description();
		}
		if (editorKey == MtcViewsRepository.File.Advanced.referencedResources) {
			return MtcPackage.eINSTANCE.getMTCResource_ReferencedResources();
		}
		if (editorKey == MtcViewsRepository.File.Basic.technology) {
			return MtcPackage.eINSTANCE.getMTCResource_Technology();
		}
		if (editorKey == MtcViewsRepository.File.Basic.type) {
			return MtcPackage.eINSTANCE.getFile_Type();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (MtcViewsRepository.File.Advanced.properties == event.getAffectedEditor()) {
		...
		if (MtcViewsRepository.File.Basic.name == event.getAffectedEditor()) {
			file.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (MtcViewsRepository.File.Basic.uRI == event.getAffectedEditor()) {
			file.setURI((String)event.getNewValue());
		}
		if (MtcViewsRepository.File.Advanced.tags == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (MtcViewsRepository.File.Basic.description == event.getAffectedEditor()) {
			file.setDescription((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (MtcViewsRepository.File.Advanced.referencedResources == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (MtcViewsRepository.File.Basic.technology == event.getAffectedEditor()) {
			file.setTechnology((String)event.getNewValue());
		}
		if (MtcViewsRepository.File.Basic.type == event.getAffectedEditor()) {
			file.setType((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
	}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (MtcPackage.eINSTANCE.getConfigurable_Properties().equals(msg.getFeature()) && isAccessible(MtcViewsRepository.File.Advanced.properties))
				basePart.updateProperties();
			if (MtcPackage.eINSTANCE.getMTCResource_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(MtcViewsRepository.File.Basic.name)) {
			...
			if (MtcPackage.eINSTANCE.getMTCResource_URI().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(MtcViewsRepository.File.Basic.uRI)) {
				if (msg.getNewValue() != null) {
			...
			if (MtcPackage.eINSTANCE.getMTCResource_Tags().equals(msg.getFeature())  && isAccessible(MtcViewsRepository.File.Advanced.tags))
				basePart.updateTags();
			if (MtcPackage.eINSTANCE.getMTCResource_Description().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(MtcViewsRepository.File.Basic.description)) {
				if (msg.getNewValue() != null) {
			...
			if (MtcPackage.eINSTANCE.getMTCResource_ReferencedResources().equals(msg.getFeature())  && isAccessible(MtcViewsRepository.File.Advanced.referencedResources))
				basePart.updateReferencedResources();
			if (MtcPackage.eINSTANCE.getMTCResource_Technology().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(MtcViewsRepository.File.Basic.technology)) {
				if (msg.getNewValue() != null) {
			...
			if (MtcPackage.eINSTANCE.getFile_Type().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(MtcViewsRepository.File.Basic.type)) {
				if (msg.getNewValue() != null) {
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			MtcPackage.eINSTANCE.getFile_Type()		);
	...
	public boolean isRequired(Object key, int kind) {
		return key == MtcViewsRepository.File.Basic.name;
	}
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (MtcViewsRepository.File.Basic.type == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(MtcPackage.eINSTANCE.getFile_Type().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(MtcPackage.eINSTANCE.getFile_Type().getEAttributeType(), newValue);
				}
