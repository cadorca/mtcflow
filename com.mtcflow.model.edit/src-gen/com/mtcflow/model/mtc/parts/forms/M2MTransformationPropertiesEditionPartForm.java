 ...
 * 
 */
public class M2MTransformationPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, M2MTransformationPropertiesEditionPart {
	 ...
	 */
	public M2MTransformationPropertiesEditionPartForm() {
		super();
	}
	 ...
	 * 
	 */
	public M2MTransformationPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	public void createControls(final FormToolkit widgetFactory, Composite view) {
		...
		m2MTransformationStep.addStep(MtcViewsRepository.M2MTransformation.Libraries.class).addStep(MtcViewsRepository.M2MTransformation.Libraries.libraries_);
	...
	protected Composite createBasicGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		basicSection.setText(MtcMessages.M2MTransformationPropertiesEditionPart_BasicGroupLabel);
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Basic.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Basic.name, PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null, name.getText()));
				}
			}
			...
			public void focusGained(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_GAINED, null, null));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.M2MTransformation.Basic.name, MtcViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createURISelectionDialog(FormToolkit widgetFactory, Composite parent) {
		...
		uRI.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Basic.uRI, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, uRI.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.M2MTransformation.Basic.uRI, MtcViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createImplementationClassSelectionDialog(FormToolkit widgetFactory, Composite parent) {
		...
		implementationClass.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Basic.implementationClass, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, implementationClass.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.M2MTransformation.Basic.implementationClass, MtcViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Basic.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Basic.description, PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null, description.getText()));
				}
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.M2MTransformation.Basic.description, MtcViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createTechnologySelectionDialog(FormToolkit widgetFactory, Composite parent) {
		...
		technology.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Basic.technology, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, technology.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.M2MTransformation.Basic.technology, MtcViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPreExecutionScriptFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		preExecutionScript = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(MtcViewsRepository.M2MTransformation.Basic.preExecutionScript, MtcViewsRepository.FORM_KIND));
		...
		preExecutionScript.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Basic.preExecutionScript, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getPreExecutionScript()));
			}

		});
		preExecutionScript.setID(MtcViewsRepository.M2MTransformation.Basic.preExecutionScript);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.M2MTransformation.Basic.preExecutionScript, MtcViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPostExecutionScriptFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		postExecutionScript = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(MtcViewsRepository.M2MTransformation.Basic.postExecutionScript, MtcViewsRepository.FORM_KIND));
		...
		postExecutionScript.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Basic.postExecutionScript, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getPostExecutionScript()));
			}

		});
		postExecutionScript.setID(MtcViewsRepository.M2MTransformation.Basic.postExecutionScript);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.M2MTransformation.Basic.postExecutionScript, MtcViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createLibrariesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		librariesSection.setText(MtcMessages.M2MTransformationPropertiesEditionPart_LibrariesGroupLabel);
	...
	protected Composite createLibrariesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.libraries = new ReferencesTable(getDescription(MtcViewsRepository.M2MTransformation.Libraries.libraries_, MtcMessages.M2MTransformationPropertiesEditionPart_LibrariesLabel), new ReferencesTableListener() {
		...
		this.libraries.setHelpText(propertiesEditionComponent.getHelpContent(MtcViewsRepository.M2MTransformation.Libraries.libraries_, MtcViewsRepository.FORM_KIND));
		this.libraries.createControls(parent, widgetFactory);
		this.libraries.addSelectionListener(new SelectionAdapter() {

			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Libraries.libraries_, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(libraries.getInput(), librariesFilters, librariesBusinessFilters, "libraries", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Libraries.libraries_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				libraries.refresh();
			}
		};
	...
	protected void moveLibraries(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Libraries.libraries_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		libraries.refresh();
	}
	...
	protected void removeFromLibraries(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Libraries.libraries_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		libraries.refresh();
	}
	...
	protected Composite createAdvancedGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		advancedSection.setText(MtcMessages.M2MTransformationPropertiesEditionPart_AdvancedGroupLabel);
	...
	protected Composite createPropertiesTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.properties = new ReferencesTable(getDescription(MtcViewsRepository.M2MTransformation.Advanced.properties, MtcMessages.M2MTransformationPropertiesEditionPart_PropertiesLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Advanced.properties, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				properties.refresh();
			}

			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Advanced.properties, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				properties.refresh();
			}

			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Advanced.properties, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				properties.refresh();
			}

			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Advanced.properties, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				properties.refresh();
			}
		...
		this.properties.setHelpText(propertiesEditionComponent.getHelpContent(MtcViewsRepository.M2MTransformation.Advanced.properties, MtcViewsRepository.FORM_KIND));
		this.properties.createControls(parent, widgetFactory);
		this.properties.addSelectionListener(new SelectionAdapter() {

			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Advanced.properties, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createTagsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.tags = new ReferencesTable(getDescription(MtcViewsRepository.M2MTransformation.Advanced.tags, MtcMessages.M2MTransformationPropertiesEditionPart_TagsLabel), new ReferencesTableListener() {
			public void handleAdd() {
				addTags();
			}
		...
		this.tags.setHelpText(propertiesEditionComponent.getHelpContent(MtcViewsRepository.M2MTransformation.Advanced.tags, MtcViewsRepository.FORM_KIND));
		this.tags.createControls(parent, widgetFactory);
		this.tags.addSelectionListener(new SelectionAdapter() {

			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Advanced.tags, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addTags() {
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(tags.getInput(), tagsFilters, tagsBusinessFilters, "tags", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Advanced.tags, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				tags.refresh();
			}
		};
	...
	protected void moveTags(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Advanced.tags, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		tags.refresh();
	}
	...
	protected void removeFromTags(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Advanced.tags, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		tags.refresh();
	}
	...
	protected Composite createReferencedResourcesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.referencedResources = new ReferencesTable(getDescription(MtcViewsRepository.M2MTransformation.Advanced.referencedResources, MtcMessages.M2MTransformationPropertiesEditionPart_ReferencedResourcesLabel), new ReferencesTableListener() {
			public void handleAdd() {
		...
		this.referencedResources.setHelpText(propertiesEditionComponent.getHelpContent(MtcViewsRepository.M2MTransformation.Advanced.referencedResources, MtcViewsRepository.FORM_KIND));
		...
		this.referencedResources.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Advanced.referencedResources, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addReferencedResources() {
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(referencedResources.getInput(), referencedResourcesFilters, referencedResourcesBusinessFilters, "referencedResources", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Advanced.referencedResources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveReferencedResources(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Advanced.referencedResources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		referencedResources.refresh();
	}
	...
	protected void removeFromReferencedResources(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Advanced.referencedResources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		referencedResources.refresh();
	}
	...
	protected Composite createDependenciesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		dependenciesSection.setText(MtcMessages.M2MTransformationPropertiesEditionPart_DependenciesGroupLabel);
	...
	protected Composite createModelDependenciesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.modelDependencies = new ReferencesTable(getDescription(MtcViewsRepository.M2MTransformation.Dependencies.modelDependencies, MtcMessages.M2MTransformationPropertiesEditionPart_ModelDependenciesLabel), new ReferencesTableListener() {
			public void handleAdd() {
		...
		this.modelDependencies.setHelpText(propertiesEditionComponent.getHelpContent(MtcViewsRepository.M2MTransformation.Dependencies.modelDependencies, MtcViewsRepository.FORM_KIND));
		...
		this.modelDependencies.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Dependencies.modelDependencies, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addModelDependencies() {
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(modelDependencies.getInput(), modelDependenciesFilters, modelDependenciesBusinessFilters, "modelDependencies", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Dependencies.modelDependencies, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveModelDependencies(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Dependencies.modelDependencies, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		modelDependencies.refresh();
	}
	...
	protected void removeFromModelDependencies(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Dependencies.modelDependencies, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		modelDependencies.refresh();
	}
	...
	protected Composite createFileDependenciesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.fileDependencies = new ReferencesTable(getDescription(MtcViewsRepository.M2MTransformation.Dependencies.fileDependencies, MtcMessages.M2MTransformationPropertiesEditionPart_FileDependenciesLabel), new ReferencesTableListener() {
			public void handleAdd() {
				addFileDependencies();
			}
		...
		this.fileDependencies.setHelpText(propertiesEditionComponent.getHelpContent(MtcViewsRepository.M2MTransformation.Dependencies.fileDependencies, MtcViewsRepository.FORM_KIND));
		this.fileDependencies.createControls(parent, widgetFactory);
		this.fileDependencies.addSelectionListener(new SelectionAdapter() {

			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Dependencies.fileDependencies, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addFileDependencies() {
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(fileDependencies.getInput(), fileDependenciesFilters, fileDependenciesBusinessFilters, "fileDependencies", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Dependencies.fileDependencies, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveFileDependencies(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Dependencies.fileDependencies, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		fileDependencies.refresh();
	}
	...
	protected void removeFromFileDependencies(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(M2MTransformationPropertiesEditionPartForm.this, MtcViewsRepository.M2MTransformation.Dependencies.fileDependencies, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		fileDependencies.refresh();
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#setName(String
	 *      newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#setURI(String
	 *      newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#setImplementationClass(String
	 *      newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#setDescription(String
	 *      newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#setTechnology(String
	 *      newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#setPreExecutionScript(EObject
	 *      newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#setPreExecutionScriptButtonMode(ButtonsModeEnum
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#addFilterPreExecutionScript(ViewerFilter
	 *      filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#addBusinessFilterPreExecutionScript(ViewerFilter
	 *      filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#setPostExecutionScript(EObject
	 *      newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#setPostExecutionScriptButtonMode(ButtonsModeEnum
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#addFilterPostExecutionScript(ViewerFilter
	 *      filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#addBusinessFilterPostExecutionScript(ViewerFilter
	 *      filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#addFilterLibraries(ViewerFilter
	 *      filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#addBusinessFilterLibraries(ViewerFilter
	 *      filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#isContainedInLibrariesTable(EObject
	 *      element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#initProperties(EObject
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#addFilterProperties(ViewerFilter
	 *      filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#addBusinessFilterProperties(ViewerFilter
	 *      filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#isContainedInPropertiesTable(EObject
	 *      element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#addFilterTags(ViewerFilter
	 *      filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#addBusinessFilterTags(ViewerFilter
	 *      filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#isContainedInTagsTable(EObject
	 *      element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#addFilterReferencedResources(ViewerFilter
	 *      filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#addBusinessFilterReferencedResources(ViewerFilter
	 *      filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#isContainedInReferencedResourcesTable(EObject
	 *      element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#addFilterModelDependencies(ViewerFilter
	 *      filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#addBusinessFilterModelDependencies(ViewerFilter
	 *      filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#isContainedInModelDependenciesTable(EObject
	 *      element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#addFilterFileDependencies(ViewerFilter
	 *      filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#addBusinessFilterFileDependencies(ViewerFilter
	 *      filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.M2MTransformationPropertiesEditionPart#isContainedInFileDependenciesTable(EObject
	 *      element)
	 * 
	 */
