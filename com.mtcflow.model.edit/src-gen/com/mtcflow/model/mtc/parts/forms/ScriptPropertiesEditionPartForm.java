...
public class ScriptPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ScriptPropertiesEditionPart {
	 ...
	 */
	public ScriptPropertiesEditionPartForm() {
		super();
	}
	...
	protected Composite createBasicGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		basicSection.setText(MtcMessages.ScriptPropertiesEditionPart_BasicGroupLabel);
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScriptPropertiesEditionPartForm.this, MtcViewsRepository.Script.Basic.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScriptPropertiesEditionPartForm.this, MtcViewsRepository.Script.Basic.name, PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null, name.getText()));
				}
			}
			...
			public void focusGained(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScriptPropertiesEditionPartForm.this, null, PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_GAINED, null, null));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.Script.Basic.name, MtcViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createURISelectionDialog(FormToolkit widgetFactory, Composite parent) {
		...
		uRI.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScriptPropertiesEditionPartForm.this, MtcViewsRepository.Script.Basic.uRI, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, uRI.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.Script.Basic.uRI, MtcViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createImplementationClassSelectionDialog(FormToolkit widgetFactory, Composite parent) {
		...
		implementationClass.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScriptPropertiesEditionPartForm.this, MtcViewsRepository.Script.Basic.implementationClass, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, implementationClass.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.Script.Basic.implementationClass, MtcViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScriptPropertiesEditionPartForm.this, MtcViewsRepository.Script.Basic.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScriptPropertiesEditionPartForm.this, MtcViewsRepository.Script.Basic.description, PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null, description.getText()));
				}
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.Script.Basic.description, MtcViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createTechnologySelectionDialog(FormToolkit widgetFactory, Composite parent) {
		...
		technology.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScriptPropertiesEditionPartForm.this, MtcViewsRepository.Script.Basic.technology, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, technology.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.Script.Basic.technology, MtcViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createAdvancedGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		advancedSection.setText(MtcMessages.ScriptPropertiesEditionPart_AdvancedGroupLabel);
	...
	protected Composite createPropertiesTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.properties = new ReferencesTable(getDescription(MtcViewsRepository.Script.Advanced.properties, MtcMessages.ScriptPropertiesEditionPart_PropertiesLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScriptPropertiesEditionPartForm.this, MtcViewsRepository.Script.Advanced.properties, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				properties.refresh();
			}

			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScriptPropertiesEditionPartForm.this, MtcViewsRepository.Script.Advanced.properties, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				properties.refresh();
			}

			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScriptPropertiesEditionPartForm.this, MtcViewsRepository.Script.Advanced.properties, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				properties.refresh();
			}

			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScriptPropertiesEditionPartForm.this, MtcViewsRepository.Script.Advanced.properties, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				properties.refresh();
			}
		...
		this.properties.setHelpText(propertiesEditionComponent.getHelpContent(MtcViewsRepository.Script.Advanced.properties, MtcViewsRepository.FORM_KIND));
		this.properties.createControls(parent, widgetFactory);
		this.properties.addSelectionListener(new SelectionAdapter() {

			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScriptPropertiesEditionPartForm.this, MtcViewsRepository.Script.Advanced.properties, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createTagsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.tags = new ReferencesTable(getDescription(MtcViewsRepository.Script.Advanced.tags, MtcMessages.ScriptPropertiesEditionPart_TagsLabel), new ReferencesTableListener() {
			public void handleAdd() {
				addTags();
			}
		...
		this.tags.setHelpText(propertiesEditionComponent.getHelpContent(MtcViewsRepository.Script.Advanced.tags, MtcViewsRepository.FORM_KIND));
		this.tags.createControls(parent, widgetFactory);
		this.tags.addSelectionListener(new SelectionAdapter() {

			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScriptPropertiesEditionPartForm.this, MtcViewsRepository.Script.Advanced.tags, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(tags.getInput(), tagsFilters, tagsBusinessFilters, "tags", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScriptPropertiesEditionPartForm.this, MtcViewsRepository.Script.Advanced.tags, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				tags.refresh();
			}
		};
	...
	protected void moveTags(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScriptPropertiesEditionPartForm.this, MtcViewsRepository.Script.Advanced.tags, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		tags.refresh();
	}
	...
	protected void removeFromTags(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScriptPropertiesEditionPartForm.this, MtcViewsRepository.Script.Advanced.tags, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		tags.refresh();
	}
	...
	protected Composite createReferencedResourcesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.referencedResources = new ReferencesTable(getDescription(MtcViewsRepository.Script.Advanced.referencedResources, MtcMessages.ScriptPropertiesEditionPart_ReferencedResourcesLabel), new ReferencesTableListener() {
			public void handleAdd() {
		...
		this.referencedResources.setHelpText(propertiesEditionComponent.getHelpContent(MtcViewsRepository.Script.Advanced.referencedResources, MtcViewsRepository.FORM_KIND));
		...
		this.referencedResources.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScriptPropertiesEditionPartForm.this, MtcViewsRepository.Script.Advanced.referencedResources, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addReferencedResources() {
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(referencedResources.getInput(), referencedResourcesFilters, referencedResourcesBusinessFilters, "referencedResources", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScriptPropertiesEditionPartForm.this, MtcViewsRepository.Script.Advanced.referencedResources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveReferencedResources(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScriptPropertiesEditionPartForm.this, MtcViewsRepository.Script.Advanced.referencedResources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		referencedResources.refresh();
	}
	...
	protected void removeFromReferencedResources(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ScriptPropertiesEditionPartForm.this, MtcViewsRepository.Script.Advanced.referencedResources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		referencedResources.refresh();
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.ScriptPropertiesEditionPart#setName(String
	 *      newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.ScriptPropertiesEditionPart#setURI(String
	 *      newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.ScriptPropertiesEditionPart#setImplementationClass(String
	 *      newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.ScriptPropertiesEditionPart#setDescription(String
	 *      newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.ScriptPropertiesEditionPart#setTechnology(String
	 *      newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.ScriptPropertiesEditionPart#initProperties(EObject
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.ScriptPropertiesEditionPart#addFilterProperties(ViewerFilter
	 *      filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.ScriptPropertiesEditionPart#addBusinessFilterProperties(ViewerFilter
	 *      filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.ScriptPropertiesEditionPart#isContainedInPropertiesTable(EObject
	 *      element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.ScriptPropertiesEditionPart#addFilterTags(ViewerFilter
	 *      filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.ScriptPropertiesEditionPart#addBusinessFilterTags(ViewerFilter
	 *      filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.ScriptPropertiesEditionPart#isContainedInTagsTable(EObject
	 *      element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.ScriptPropertiesEditionPart#addFilterReferencedResources(ViewerFilter
	 *      filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.ScriptPropertiesEditionPart#addBusinessFilterReferencedResources(ViewerFilter
	 *      filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.mtcflow.model.mtc.parts.ScriptPropertiesEditionPart#isContainedInReferencedResourcesTable(EObject
	 *      element)
	 * 
	 */
