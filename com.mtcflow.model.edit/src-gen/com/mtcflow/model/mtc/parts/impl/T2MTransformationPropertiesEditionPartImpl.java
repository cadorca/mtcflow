 ...
 * 
 */
public class T2MTransformationPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, T2MTransformationPropertiesEditionPart {
	 ...
	 * 
	 */
	public T2MTransformationPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createBasicGroup(Composite parent) {
		...
		basicGroup.setText(MtcMessages.T2MTransformationPropertiesEditionPart_BasicGroupLabel);
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Basic.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.T2MTransformation.Basic.name, MtcViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createURISelectionDialog(Composite parent) {
		...
		uRI.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Basic.uRI, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, uRI.getText()));
			}
		});
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.T2MTransformation.Basic.uRI, MtcViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createImplementationClassSelectionDialog(Composite parent) {
		...
		implementationClass.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Basic.implementationClass, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, implementationClass.getText()));
			}
		});
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.T2MTransformation.Basic.implementationClass, MtcViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createDescriptionText(Composite parent) {
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Basic.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.T2MTransformation.Basic.description, MtcViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createTechnologySelectionDialog(Composite parent) {
		...
		technology.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Basic.technology, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, technology.getText()));
			}
		});
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.T2MTransformation.Basic.technology, MtcViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPreExecutionScriptFlatComboViewer(Composite parent) {
		...
		preExecutionScript = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(MtcViewsRepository.T2MTransformation.Basic.preExecutionScript, MtcViewsRepository.SWT_KIND));
		...
		preExecutionScript.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Basic.preExecutionScript, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getPreExecutionScript()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.T2MTransformation.Basic.preExecutionScript, MtcViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPostExecutionScriptFlatComboViewer(Composite parent) {
		...
		postExecutionScript = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(MtcViewsRepository.T2MTransformation.Basic.postExecutionScript, MtcViewsRepository.SWT_KIND));
		...
		postExecutionScript.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Basic.postExecutionScript, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getPostExecutionScript()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.T2MTransformation.Basic.postExecutionScript, MtcViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createLibrariesGroup(Composite parent) {
		...
		librariesGroup.setText(MtcMessages.T2MTransformationPropertiesEditionPart_LibrariesGroupLabel);
	...
	protected Composite createLibrariesAdvancedReferencesTable(Composite parent) {
		String label = getDescription(MtcViewsRepository.T2MTransformation.Libraries.libraries_, MtcMessages.T2MTransformationPropertiesEditionPart_LibrariesLabel);		 
		...
		this.libraries.setHelpText(propertiesEditionComponent.getHelpContent(MtcViewsRepository.T2MTransformation.Libraries.libraries_, MtcViewsRepository.SWT_KIND));
		this.libraries.createControls(parent);
		this.libraries.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Libraries.libraries_, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"libraries", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Libraries.libraries_,
	...
	protected void moveLibraries(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Libraries.libraries_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		libraries.refresh();
	}
	...
	protected void removeFromLibraries(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Libraries.libraries_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		libraries.refresh();
	}
	...
	protected Composite createAdvancedGroup(Composite parent) {
		...
		advancedGroup.setText(MtcMessages.T2MTransformationPropertiesEditionPart_AdvancedGroupLabel);
	...
	protected Composite createPropertiesAdvancedTableComposition(Composite parent) {
		this.properties = new ReferencesTable(getDescription(MtcViewsRepository.T2MTransformation.Advanced.properties, MtcMessages.T2MTransformationPropertiesEditionPart_PropertiesLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Advanced.properties, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				properties.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Advanced.properties, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				properties.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Advanced.properties, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				properties.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Advanced.properties, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				properties.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.properties.setHelpText(propertiesEditionComponent.getHelpContent(MtcViewsRepository.T2MTransformation.Advanced.properties, MtcViewsRepository.SWT_KIND));
		this.properties.createControls(parent);
		this.properties.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Advanced.properties, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createTagsAdvancedReferencesTable(Composite parent) {
		String label = getDescription(MtcViewsRepository.T2MTransformation.Advanced.tags, MtcMessages.T2MTransformationPropertiesEditionPart_TagsLabel);		 
		...
		this.tags.setHelpText(propertiesEditionComponent.getHelpContent(MtcViewsRepository.T2MTransformation.Advanced.tags, MtcViewsRepository.SWT_KIND));
		this.tags.createControls(parent);
		this.tags.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Advanced.tags, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addTags() {
		...
		"tags", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Advanced.tags,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				tags.refresh();
			}
	...
	protected void moveTags(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Advanced.tags, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		tags.refresh();
	}
	...
	protected void removeFromTags(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Advanced.tags, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		tags.refresh();
	}
	...
	protected Composite createReferencedResourcesAdvancedReferencesTable(Composite parent) {
		String label = getDescription(MtcViewsRepository.T2MTransformation.Advanced.referencedResources, MtcMessages.T2MTransformationPropertiesEditionPart_ReferencedResourcesLabel);		 
		...
		this.referencedResources.setHelpText(propertiesEditionComponent.getHelpContent(MtcViewsRepository.T2MTransformation.Advanced.referencedResources, MtcViewsRepository.SWT_KIND));
		this.referencedResources.createControls(parent);
		this.referencedResources.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Advanced.referencedResources, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addReferencedResources() {
		...
		"referencedResources", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Advanced.referencedResources,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveReferencedResources(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Advanced.referencedResources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		referencedResources.refresh();
	}
	...
	protected void removeFromReferencedResources(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Advanced.referencedResources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		referencedResources.refresh();
	}
	...
	protected Composite createDependenciesGroup(Composite parent) {
		...
		dependenciesGroup.setText(MtcMessages.T2MTransformationPropertiesEditionPart_DependenciesGroupLabel);
	...
	protected Composite createFileDependenciesAdvancedReferencesTable(Composite parent) {
		String label = getDescription(MtcViewsRepository.T2MTransformation.Dependencies.fileDependencies, MtcMessages.T2MTransformationPropertiesEditionPart_FileDependenciesLabel);		 
		...
		this.fileDependencies.setHelpText(propertiesEditionComponent.getHelpContent(MtcViewsRepository.T2MTransformation.Dependencies.fileDependencies, MtcViewsRepository.SWT_KIND));
		this.fileDependencies.createControls(parent);
		this.fileDependencies.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Dependencies.fileDependencies, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addFileDependencies() {
		...
		"fileDependencies", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Dependencies.fileDependencies,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveFileDependencies(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Dependencies.fileDependencies, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		fileDependencies.refresh();
	}
	...
	protected void removeFromFileDependencies(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Dependencies.fileDependencies, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		fileDependencies.refresh();
	}
	...
	protected Composite createModelDependenciesAdvancedReferencesTable(Composite parent) {
		String label = getDescription(MtcViewsRepository.T2MTransformation.Dependencies.modelDependencies, MtcMessages.T2MTransformationPropertiesEditionPart_ModelDependenciesLabel);		 
		...
		this.modelDependencies.setHelpText(propertiesEditionComponent.getHelpContent(MtcViewsRepository.T2MTransformation.Dependencies.modelDependencies, MtcViewsRepository.SWT_KIND));
		this.modelDependencies.createControls(parent);
		this.modelDependencies.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Dependencies.modelDependencies, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addModelDependencies() {
		...
		"modelDependencies", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Dependencies.modelDependencies,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveModelDependencies(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Dependencies.modelDependencies, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		modelDependencies.refresh();
	}
	...
	protected void removeFromModelDependencies(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(T2MTransformationPropertiesEditionPartImpl.this, MtcViewsRepository.T2MTransformation.Dependencies.modelDependencies, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		modelDependencies.refresh();
	}
