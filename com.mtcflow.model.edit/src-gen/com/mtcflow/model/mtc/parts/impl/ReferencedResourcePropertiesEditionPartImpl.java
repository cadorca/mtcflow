 ...
 * 
 */
public class ReferencedResourcePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ReferencedResourcePropertiesEditionPart {
	 ...
	 * 
	 */
	public ReferencedResourcePropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createBasicGroup(Composite parent) {
		...
		basicGroup.setText(MtcMessages.ReferencedResourcePropertiesEditionPart_BasicGroupLabel);
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReferencedResourcePropertiesEditionPartImpl.this, MtcViewsRepository.ReferencedResource.Basic.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.ReferencedResource.Basic.name, MtcViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createURISelectionDialog(Composite parent) {
		...
		uRI.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReferencedResourcePropertiesEditionPartImpl.this, MtcViewsRepository.ReferencedResource.Basic.uRI, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, uRI.getText()));
			}
		});
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.ReferencedResource.Basic.uRI, MtcViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createTypeText(Composite parent) {
		...
		type.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReferencedResourcePropertiesEditionPartImpl.this, MtcViewsRepository.ReferencedResource.Basic.type, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, type.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.ReferencedResource.Basic.type, MtcViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createDescriptionText(Composite parent) {
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReferencedResourcePropertiesEditionPartImpl.this, MtcViewsRepository.ReferencedResource.Basic.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.ReferencedResource.Basic.description, MtcViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createTechnologySelectionDialog(Composite parent) {
		...
		technology.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReferencedResourcePropertiesEditionPartImpl.this, MtcViewsRepository.ReferencedResource.Basic.technology, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, technology.getText()));
			}
		});
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(MtcViewsRepository.ReferencedResource.Basic.technology, MtcViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createAdvancedGroup(Composite parent) {
		...
		advancedGroup.setText(MtcMessages.ReferencedResourcePropertiesEditionPart_AdvancedGroupLabel);
	...
	protected Composite createPropertiesAdvancedTableComposition(Composite parent) {
		this.properties = new ReferencesTable(getDescription(MtcViewsRepository.ReferencedResource.Advanced.properties, MtcMessages.ReferencedResourcePropertiesEditionPart_PropertiesLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReferencedResourcePropertiesEditionPartImpl.this, MtcViewsRepository.ReferencedResource.Advanced.properties, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				properties.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReferencedResourcePropertiesEditionPartImpl.this, MtcViewsRepository.ReferencedResource.Advanced.properties, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				properties.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReferencedResourcePropertiesEditionPartImpl.this, MtcViewsRepository.ReferencedResource.Advanced.properties, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				properties.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReferencedResourcePropertiesEditionPartImpl.this, MtcViewsRepository.ReferencedResource.Advanced.properties, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				properties.refresh();
			}
		...
		this.properties.setHelpText(propertiesEditionComponent.getHelpContent(MtcViewsRepository.ReferencedResource.Advanced.properties, MtcViewsRepository.SWT_KIND));
		this.properties.createControls(parent);
		this.properties.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReferencedResourcePropertiesEditionPartImpl.this, MtcViewsRepository.ReferencedResource.Advanced.properties, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createReferencedResourcesAdvancedReferencesTable(Composite parent) {
		String label = getDescription(MtcViewsRepository.ReferencedResource.Advanced.referencedResources, MtcMessages.ReferencedResourcePropertiesEditionPart_ReferencedResourcesLabel);		 
		...
		this.referencedResources.setHelpText(propertiesEditionComponent.getHelpContent(MtcViewsRepository.ReferencedResource.Advanced.referencedResources, MtcViewsRepository.SWT_KIND));
		this.referencedResources.createControls(parent);
		this.referencedResources.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReferencedResourcePropertiesEditionPartImpl.this, MtcViewsRepository.ReferencedResource.Advanced.referencedResources, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"referencedResources", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReferencedResourcePropertiesEditionPartImpl.this, MtcViewsRepository.ReferencedResource.Advanced.referencedResources,
	...
	protected void moveReferencedResources(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReferencedResourcePropertiesEditionPartImpl.this, MtcViewsRepository.ReferencedResource.Advanced.referencedResources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		referencedResources.refresh();
	}
	...
	protected void removeFromReferencedResources(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReferencedResourcePropertiesEditionPartImpl.this, MtcViewsRepository.ReferencedResource.Advanced.referencedResources, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		referencedResources.refresh();
	}
	...
	protected Composite createTagsAdvancedReferencesTable(Composite parent) {
		String label = getDescription(MtcViewsRepository.ReferencedResource.Advanced.tags, MtcMessages.ReferencedResourcePropertiesEditionPart_TagsLabel);		 
		...
		this.tags.setHelpText(propertiesEditionComponent.getHelpContent(MtcViewsRepository.ReferencedResource.Advanced.tags, MtcViewsRepository.SWT_KIND));
		this.tags.createControls(parent);
		this.tags.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReferencedResourcePropertiesEditionPartImpl.this, MtcViewsRepository.ReferencedResource.Advanced.tags, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addTags() {
		...
		"tags", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReferencedResourcePropertiesEditionPartImpl.this, MtcViewsRepository.ReferencedResource.Advanced.tags,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				tags.refresh();
			}
	...
	protected void moveTags(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReferencedResourcePropertiesEditionPartImpl.this, MtcViewsRepository.ReferencedResource.Advanced.tags, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		tags.refresh();
	}
	...
	protected void removeFromTags(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReferencedResourcePropertiesEditionPartImpl.this, MtcViewsRepository.ReferencedResource.Advanced.tags, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		tags.refresh();
	}
