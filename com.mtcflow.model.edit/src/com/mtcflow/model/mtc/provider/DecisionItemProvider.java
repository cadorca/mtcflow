...
/**
 * This is the item provider adapter for a {@link com.mtcflow.model.mtc.Decision} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DecisionItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addExpresionPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MtcPackage.Literals.DECISION__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Expresion feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addExpresionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Decision_expresion_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Decision_expresion_feature", "_UI_Decision_type"),
				 MtcPackage.Literals.DECISION__EXPRESION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addImplementationClassPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Decision_implementationClass_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Decision_implementationClass_feature", "_UI_Decision_type"),
				 MtcPackage.Literals.DECISION__IMPLEMENTATION_CLASS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MtcPackage.Literals.DECISION__CHOISES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("decision.png"));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MtcPackage.Literals.DECISION__CHOISES,
				 MtcFactory.eINSTANCE.createChoise()));
	}
